import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.99e5893c.js";const u=JSON.parse('{"title":"Vue学习笔记-调试测试","description":"","frontmatter":{},"headers":[],"relativePath":"note/vue.md","filePath":"note/vue.md"}'),p={name:"note/vue.md"},e=l(`<h1 id="vue学习笔记-调试测试" tabindex="-1">Vue学习笔记-调试测试 <a class="header-anchor" href="#vue学习笔记-调试测试" aria-label="Permalink to &quot;Vue学习笔记-调试测试&quot;">​</a></h1><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">VNode</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> {</span></span>
